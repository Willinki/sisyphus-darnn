...
uv run python scripts/python_scripts/main.py \
    ...
    'model.kwargs.threshold_in=1.5,1.7' \
    'model.kwargs.threshold_j=1.5,1.7' \
    model.kwargs.threshold_out=3.8 \
    model.kwargs.strength_forth=4.7\
    'model.kwargs.strength_back=1.5,1.6,1.7' \
...
uv run python scripts/python_scripts/main.py \
    ...
    'model.kwargs.strength_back=1.5,1.6,1.7' \
    optimizer.weight_decay_j=0.0004 \
    optimizer.weight_decay_win=0.001 \
    optimizer.weight_decay_wout=0.001 \
    optimizer.learning_rate_j=0.03 \
    optimizer.learning_rate_win=0.02 \
    optimizer.learning_rate_wout=0.17 \
    trainer.fake_dynamics.k=0.5
...
uv run python scripts/python_scripts/main.py \
    ...
    optimizer.weight_decay_wout=0.02 \
    optimizer.learning_rate_j=0.1 \
    optimizer.learning_rate_win=0.07 \
    optimizer.learning_rate_wout=0.17 \
    trainer.fake_dynamics.k=0.5
...
uv run python scripts/python_scripts/main.py \
    ...
    model.kwargs.strength_forth=4.7\
    'model.kwargs.strength_back=1.5,1.6,1.7' \
    optimizer.weight_decay_j=0.0003 \
    optimizer.weight_decay_win=0.0001 \
    optimizer.weight_decay_wout=0.02 \
    optimizer.learning_rate_j=0.05 \
    optimizer.learning_rate_win=0.15 \
    optimizer.learning_rate_wout=0.17 \
    trainer.fake_dynamics.k=0.5