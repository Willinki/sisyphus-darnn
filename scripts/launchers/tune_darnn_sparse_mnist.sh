...
echo "Task index: ${idx} -> dim_hidden=${dim_hidden}, sparsity=${sparsity}"

uv run python3.11 scripts/parameter_tuning/asha_scheduler.py --dim_hidden "${dim_hidden}" --sparsity "${sparsity}"