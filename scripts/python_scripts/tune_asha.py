...
def build_command(trial: optuna.trial.Trial) -> list[str]:
    ...
    # ------------------------
    strength_back = trial.suggest_float("strength_back", 1.5, 1.9)
    strength_forth = trial.suggest_float("strength_forth", 4.7, 5.1)
    threshold_in = trial.suggest_float("threshold_in", 1.5, 1.8)
    threshold_j = trial.suggest_float("threshold_j", 1.5, 1.8)
    threshold_back = 0.0
    j_d = trial.suggest_float("j_d", 0.8, 1.0)
    ...
    weight_decay_j = trial.suggest_float("weight_decay_j", 5e-5, 3e-4, log=True)
    weight_decay_win = trial.suggest_float("weight_decay_win", 5e-4, 2e-2, log=True)
